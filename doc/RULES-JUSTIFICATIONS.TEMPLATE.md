...
| [1040](#1040) | setresourcerequestsandlimits                | K8s     | Set `resources.requests` for every container             | 4·5·6                 | Avoids overcommit; scheduler density +20 to +40 %                         | ★★★ | `[Verma-2015]` · `[K8s-Resource-Mgmt]`                              |
