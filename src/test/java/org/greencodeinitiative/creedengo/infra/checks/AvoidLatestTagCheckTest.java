...
class AvoidLatestTagCheckTest {

  private final IacCheck check = new AvoidLatestTagCheck();

  private static final String MSG_LATEST =
  ...
  @Test
  void shouldRaiseOnLatestOrImplicitTag() {
    DockerVerifier.verifyIssues("AvoidLatestTagCheck/noncompliant.Dockerfile", check,
        DockerVerifier.ExpectedIssue.at(2, MSG_IMPLICIT),
        DockerVerifier.ExpectedIssue.at(3, MSG_LATEST),
